...
# body param
SchemaForRequestBodyApplicationJson = ProjectBucketBindingSchema


request_body_project_bucket_binding = api_client.RequestBody(
    content={
...
SchemaFor400ResponseBodyApplicationJson = ProjectBindBucket400ResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProjectBindBucket400Response
...
class BaseApi(api_client.Api):
    ...
    def _bind_bucket_mapped_args(
        self,
        project: ProjectBucketBindingProject,
        project_id: int,
    ...
    async def _abind_bucket_oapg(
        ...
        serialized_data = request_body_project_bucket_binding.serialize(body, content_type)
...
class BindBucket(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def abind_bucket(
        self,
        project: ProjectBucketBindingProject,
        project_id: int,
    ) -> typing.Union[
        ...
        args = self._bind_bucket_mapped_args(
            project=project,
            project_id=project_id,
        )
        return await self._abind_bucket_oapg(
            body=args.body,
