...
# body param
SchemaForRequestBodyApplicationJson = ProjectUpdateRequestSchema


request_body_project_update_request = api_client.RequestBody(
    content={
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/project/{projectId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_project_update_request.serialize(body, content_type)
