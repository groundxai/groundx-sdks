...
from groundx.model.project_create_request import ProjectCreateRequest as ProjectCreateRequestSchema
...
from groundx.type.project_create_request import ProjectCreateRequest

# body param
SchemaForRequestBodyApplicationJson = ProjectCreateRequestSchema


request_body_project_create_request = api_client.RequestBody(
    content={
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/project',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_project_create_request.serialize(body, content_type)
