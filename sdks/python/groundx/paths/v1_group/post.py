...
from groundx.model.group_create_request import GroupCreateRequest as GroupCreateRequestSchema

from groundx.type.group_create_request import GroupCreateRequest
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_group_create_request.serialize(body, content_type)
