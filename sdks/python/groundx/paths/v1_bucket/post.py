...
from groundx.model.bucket_create_request import BucketCreateRequest as BucketCreateRequestSchema

from groundx.type.bucket_create_request import BucketCreateRequest
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_bucket_create_request.serialize(body, content_type)
