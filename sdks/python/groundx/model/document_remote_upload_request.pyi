...
class DocumentRemoteUploadRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bucketId", "sourceUrl", "callbackData", "callbackUrl", "metadata", "type", "documents", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bucketId", "sourceUrl", "callbackData", "callbackUrl", "metadata", "type", "documents", ], str]):
