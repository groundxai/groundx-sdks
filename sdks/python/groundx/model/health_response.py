...
class HealthResponse(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["health"]) -> 'HealthResponseHealth': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["health"]) -> 'HealthResponseHealth': ...
